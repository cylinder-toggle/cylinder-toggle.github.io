customElements.define("cylinder-toggle",class extends HTMLElement{constructor(){super().attachShadow({mode:"open"}).innerHTML=`
            <style>
            :host {
                --hue: 223;
            ...
            @media (prefers-color-scheme: dark) {
                ...
                input {
            ...
            </style>`}connectedCallback(){this.render(),this.checked=this.hasAttribute("checked")}render(){this.shadowRoot.append(Object.assign(document.createElement("label"),{innerHTML:`<input type="checkbox" role="switch">
                    <span class="handle">
                        <span class="sides">
                            <span class="side"/>
                        </span>
                    ...
                    <span class="label">Power</span>`}))}get input(){return this.shadowRoot.querySelector("input")}get checked(){return this.hasAttribute("checked")}set checked(e){this.input.toggleAttribute("checked",e)}});